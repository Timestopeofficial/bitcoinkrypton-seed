describe('TransactionStore', () => {
    ...
    beforeAll((done) => {
        (async () => {
            ...
            const tx1 = new BasicTransaction(senderPubKey, recipientAddress1, 1, 1, signature);
            const tx2 = new ExtendedTransaction(senderAddress, Account.Type.BASIC, recipientAddress2, Account.Type.BASIC, 1, 1, Transaction.Flag.NONE, new Uint8Array(0), proof);
            const tx3 = new ExtendedTransaction(senderAddress, Account.Type.BASIC, recipientAddress1, Account.Type.BASIC, 100, 1, Transaction.Flag.NONE, new Uint8Array(0), proof);
