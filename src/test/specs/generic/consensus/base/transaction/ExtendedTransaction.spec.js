describe('ExtendedTransaction', () => {
    ...
    it('is correctly created', () => {
        const tx1 = new ExtendedTransaction(senderAddress, Account.Type.BASIC, recipientAddress, Account.Type.BASIC, value, validityStartHeight, Transaction.Flag.NONE, data, proof, networkId);
