describe('TransactionsProof', () => {
    ...
    beforeAll(() => {
        ...
        tx1 = new BasicTransaction(senderPubKey, recipientAddr, value, validityStartHeight, signature);
        tx2 = new ExtendedTransaction(senderAddress, Account.Type.BASIC, recipientAddr, Account.Type.BASIC, value, validityStartHeight, Transaction.Flag.NONE, data, proof);
