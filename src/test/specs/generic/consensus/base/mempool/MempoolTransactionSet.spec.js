describe('MempoolTransactionSet', () => {
    ...
    beforeAll(() => {
        ...
        tx1 = TestBlockchain.createTransaction(users[0].publicKey, users[1].address, 2000, 1, users[0].privateKey);
        tx2 = TestBlockchain.createTransaction(users[0].publicKey, users[1].address, 1000, 1, users[0].privateKey);
        tx3 = TestBlockchain.createTransaction(users[0].publicKey, users[1].address, 3000, 2, users[0].privateKey);
    });
