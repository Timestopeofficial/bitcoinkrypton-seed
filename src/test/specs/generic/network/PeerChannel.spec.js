describe('PeerChannel', () => {
    ...
    const count = 1;
    const addr = new WssPeerAddress(Services.DEFAULT, Date.now(), NetAddress.UNSPECIFIED, PublicKey.unserialize(BufferUtils.fromBase64(Dummy.publicKey1)), 1, 'node1.krypton.com', 12011, Signature.unserialize(BufferUtils.fromBase64(Dummy.signature1)));
