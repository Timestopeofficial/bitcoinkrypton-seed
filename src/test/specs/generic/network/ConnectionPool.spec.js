describe('ConnectionPool', () => {
    ...
    it('correctly deals with simultaneous WebSocket connections', (done) => {
        (async () => {
            ...
            const netConfig2 = new WssNetworkConfig('node2.test', 8080, 'key2', 'cert2', { enabled: false, port: 12111, address: '::ffff:127.0.0.1', header: 'x-forwarded-for'});
            ...
            const netConfig3 = new WssNetworkConfig('node3.test', 8080, 'key3', 'cert3', { enabled: false, port: 12111, address: '::ffff:127.0.0.1', header: 'x-forwarded-for'});
    ...
    it('rejects connections to blocked IPs', (done) => {
        (async () => {
            ...
            const netConfig1 = new WssNetworkConfig('attacker.test', 9000, 'key1', 'cert1', { enabled: false, port: 12111, address: '::ffff:127.0.0.1', header: 'x-forwarded-for'});
            ...
            const netConfig2 = new WssNetworkConfig('attacker.test', 9000, 'key2', 'cert2', { enabled: false, port: 12111, address: '::ffff:127.0.0.1', header: 'x-forwarded-for'});
