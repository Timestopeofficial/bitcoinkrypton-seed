describe('PeerAddress', () => {
    it('can be parsed from string', () => {
        ...
        const addrStr2 = 'wss://bla.blub.fo-o.com:12011/abe25666ee12a71bda501239f230c760c84ee50eef0a3e567897e8d5307c0b4e';
    ...
    it('rejects invalid PeerAddresses', () => {
        const addrStr1 = 'https://foobar.com:12011/';
        ...
        const addrStr4 = 'wss://foobar.com:12011/abc098';
        expect(() => WsBasePeerAddress.fromSeedString(addrStr4)).toThrowError(`Malformed PeerAddress ${addrStr4}`);

        const addrStr5 = 'wss://foobar.com:12011/abXX5666ee12a71bda501239f230c760c84ee50eef0a3e567897e8d5307c0b4e';
