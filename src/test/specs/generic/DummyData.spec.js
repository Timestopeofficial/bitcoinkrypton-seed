...
Dummy.publicKey1 = 'BNT8/xnD7UPJ+Yiu+nl41CFlkySTCVPhqoP1TWdLHNefpG0am7P3x9oAMDSnURNOXLVqfTmtAqa/qOY3WWS7suc='; // 4CYgLLc5bOEYOMext6Lmt0UxwnxuDAnr7a0iE6q2kKs=
Dummy.publicKey2 = 'BHsBPYHCOtePEnIukZVPkK9tBeCEY4QhwvJHzMQfgodY+0hKEdumjPLzOvEqcxxvi2BfOIqNK/d0rmzNW9w8wN0='; // 7YD4khdiTeFRP4WvhJv+jC3wK1r7dAJpKLTXj2DVggA=
Dummy.publicKey3 = 'BFCypNMxroZ7pJv5MBYFniS1hDLmIphOBjor8QXBcKUISJc8Kv4Yad+EgdBqIRT2+knHM7tIjopWfdVHK/ZxSLs='; // kzUhvEdaEAyrxd/+dAlb4B6nMggfL0yGK/rHjK9SnWA=
Dummy.publicKey4 = 'BEbFY9Fu17tNp3nvIIV/5t4u+V0I62i3hY9SMUYgxFZXynVORIgHwfjHU7/pcBa1m9w6cmDCdI6sm98rFRBDAGw='; // 2ahwwZmlDn6G2feY63fl6EieixknIgGL7t32uZqXahM=
Dummy.publicKey5 = 'BDP91KVLSDIHGYY9PxBuvq+ouKMenVFwus8p6rKo/M6Ud9nh4UYWClZZDLG6mpw4X46ITDrpj1fMECN2AOFCR+k='; // nl2PHWI2dSB7h8sBhGwddSdbhWzaDMPmSz2Sh5MEe8k=

Dummy.address1 = 'Ma9PSdBsIjMnpNWsHX05NdpDZNI=';
Dummy.address2 = 'bmYbiHQcq1YL0tteQQEXLmodyWw=';
Dummy.address3 = 'iZcNgl/Kem0EvhHe/imepTYYESc=';
Dummy.address4 = 'xbbxPuFrA6u+ignQQJ5qgidl2vk=';
Dummy.address5 = 'yxHrApDSpeh3REOKkItLa1LRk3w=';

Dummy.signature1 = '28/HV11addSsoezmJeMJlR8ZT/FhgudniPeUVRM9Pn8oecGVYSJDbh3JmrLBKuYKcCkROMKp1jNvFbl9UmDOlQ=='; // msg: hello0
Dummy.signature2 = 'V/5r+Gz8kD7qc211WqbiVwhwVTLQYjWPpg9DyTYOCFYtW23aD20iaFfg22elrvPsEeepI6bGxIwOfOtugpnuLA=='; // msg: hello1
Dummy.signature3 = '/2dea4OW5WfKlFn5bbmLz+966IzNV94E+Elb/IpiCgdpc8PNh0VgXLzRhwQGhby80Q3IAGqM3tC9qdQzXuaccQ=='; // msg: hello2
Dummy.signature4 = 'b65LS7PeNrRmnRU4VY1GkEK+jHYIAulbEIL1VOeOK/5+77Wgw5BO27s4DW+/Fk+LL2zKvBTULtIiZAHI6wpZIw=='; // msg: hello3
Dummy.signature5 = 'seY1s/Aycc42HhrpbN8TP13/l/5DTAs3uyPUaoxlk7A0/Hl7X/sd3Bug4nBbStV9/3xDAD6WLpvRAkKEu1lIVw=='; // msg: hello4
...
if (!offlineTarget) {
    Dummy.NETCONFIG = new WssNetworkConfig('node1.test', 9000, 'key1', 'cert1', { enabled: false, port: 12111, address: '::ffff:127.0.0.1', header: 'x-forwarded-for'});
    Dummy.NETCONFIG._keyPair = KeyPair.fromHex('1d3f4c21092485f0aa1c5fdce37d50c8b04e737ae05e2206dc32589466a09d7304bf17392c7689debdea19f9ae93501f04e09664a44906e3ee5d5e02d6b9c88f95118805529f0adc59e95abb7db8a2c58de86096db212e36a716e25083d396381a00');
}
    ...
    GenesisConfig.CONFIGS['tests'] = {
        ...
        GENESIS_BLOCK: new Block(
            new BlockHeader(
                ...
                Hash.fromBase64('08qOdFC8EHRhet7sxJPA8cqVN+FZDqYfZw9fDJfnvL0='),
        ...
        GENESIS_ACCOUNTS: 'AAIP7R94Gl77Xrk4xvszHLBXdCzC9AAAAAAAAAAABtSZ7GxjOAAACHaNp0lywvznYLnSIMNEh2UWOw0AAAAAAAAAAAbUmexsYzgAAA==',
