describe('Wallet', () => {
    ...
    it('can create a signed transaction', () => {
        ...
        const transaction = wallet.createTransaction(recipient, value, validityStartHeight);
    ...
    it('can create a valid SignatureProof', () => {
        const wallet = Wallet.generate();
        const transaction = new ExtendedTransaction(wallet.address, Account.Type.BASIC, recipient, Account.Type.BASIC, value, validityStartHeight, Transaction.Flag.NONE, new Uint8Array(0));
