...
Client.ConfigurationBuilder = class ConfigurationBuilder {
     ...
     * @param {number} [port=12011] Publicly reachable port
     * @returns {Client.ConfigurationBuilder}
     */
    ws(host, port = 12011) {
     ...
     * @returns {Client.ConfigurationBuilder}
     */
    wss(host, port = 12011, tlsKey, tlsCert) {
     ...
     * @param {number} [port=12011] Publicly reachable port (required for ws and wss)
     ...
     * @returns {Client.ConfigurationBuilder}
     */
    protocol(protocol, host, port = 12011, tlsKey, tlsCert) {
