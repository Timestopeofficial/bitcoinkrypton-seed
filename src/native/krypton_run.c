...
int main() {
    ...
    for(int i = 1; i < 4; ++i) {
        ...
        uint32_t nonce = krypton_argon2_target(out, in, strlen(in), 0x20000000u + (0xffff >> i), 0, (uint32_t)-1, 512);
