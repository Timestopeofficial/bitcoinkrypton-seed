...
class MiningPoolDetailUi {
    ...
    _updateConnectionStatus() {
        if (this._miningPoolId !== this._miner.selectedPool
            || this._miner.$.miner.connectionState === Krypton.BasePoolMiner.ConnectionState.CLOSED) {
        ...
        } else if (this._miner.$.miner.connectionState === Krypton.BasePoolMiner.ConnectionState.CONNECTED) {
    ...
    _updateBalance() {
        ...
        this._balance.textContent = Krypton.Policy.satoshisToCoins(balance).toFixed(6);
    }

    _joinOrLeave() {
        if (this._miner.$.miner.connectionState === Krypton.BasePoolMiner.ConnectionState.CLOSED
