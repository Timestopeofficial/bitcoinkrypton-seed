class RpcClient extends Krypton.Observable {
...
class RpcComponent extends Krypton.Observable {
...
class RpcMiner extends RpcComponent {
    ...
    set pool(poolOrBoolean) {
        this._rpcClient.fetch('pool', poolOrBoolean).then(pool => {
            ...
            if (pool) {
                this._propertyUpdated('poolConnectionState', Krypton.BasePoolMiner.ConnectionState.CONNECTING);
