class HtlcSignerUi {
    ...
    setAccount(address, account) {
        if (account.type !== Krypton.Account.Type.HTLC) throw Error('Not a HTLC account');
    ...
    getSigner() {
        ...
        switch (this.$proofType.value) {
            case HtlcSignerUi.ProofType.REGULAR_TRANSFER:
                proofType = Krypton.HashedTimeLockedContract.ProofType.REGULAR_TRANSFER;
                break;
            case HtlcSignerUi.ProofType.EARLY_RESOLVE:
                proofType = Krypton.HashedTimeLockedContract.ProofType.EARLY_RESOLVE;
                break;
            case HtlcSignerUi.ProofType.TIMEOUT_RESOLVE:
                proofType = Krypton.HashedTimeLockedContract.ProofType.TIMEOUT_RESOLVE;
                break;
        }
        const hashAlgorithm = Krypton.Hash.Algorithm[this.$hashAlgorithm.value.toUpperCase()];
