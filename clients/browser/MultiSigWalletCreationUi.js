class MultiSigWalletCreationUi extends Krypton.Observable {
    constructor(el, $) {
        super();
        this.$el = el;
        this.$ = $;
    ...
    _createMultiSig() {
        ...
        Promise.all(signerWalletPromises).then(signerWallets => {
            ...
            multiSigWallet = Krypton.MultiSigWallet.fromPublicKeys(signerWallets[0].keyPair, this._requiredSignerCount,
                publicKeys);
