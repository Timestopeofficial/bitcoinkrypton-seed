class SignerUi {
    ...
    _getType(address, account) {
        return Promise.all([
            ...
            const TYPE_MAP = new Map();
            TYPE_MAP.set(Krypton.Account.Type.BASIC, SignerUi.SignerType.SINGLE_SIG);
            TYPE_MAP.set(Krypton.Account.Type.VESTING, SignerUi.SignerType.VESTING);
            TYPE_MAP.set(Krypton.Account.Type.HTLC, SignerUi.SignerType.HTLC);
